...
Here is a simplified run down of what happens when Alice presses 'send' in her Lightning wallet for the transaction above. This sounds complicated, but it all happens under the hood in a matter of seconds!
